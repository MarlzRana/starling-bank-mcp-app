...
function CreatePayee() {
  const { output } = useToolInfo<'create-payee'>();

  if (!output) {
    return (
      <div className="payee-result">
        <div className="payee-result__loading">Creating payee…</div>
      </div>
    );
  }
    ...
    return (
      <div className="payee-result">
        <div className="payee-result__error">
          ...
          <span>Failed to create payee</span>
        </div>
      </div>
    );
  }
      ...
      <div className="payee-result__card payee-result__card--success">
        <div className="payee-result__header">
          ...
          <div className="payee-result__info">
            ...
            <span className="payee-result__status">Payee created</span>
          </div>
        </div>
