...
function SetupRecurringTransferInternal() {
  const { output } =
    useToolInfo<"setup-recurring-transfer-to-space-internal">();

  if (!output) {
    return (
      <div className="payee-result">
        <div className="payee-result__loading">Setting up...</div>
      </div>
    );
  }
    ...
    return (
      <div className="payee-result">
        <div className="payee-result__error">
          ...
          <span>Failed to set up recurring transfer</span>
        </div>
      </div>
    );
  }
...
export default SetupRecurringTransferInternal;
mountWidget(<SetupRecurringTransferInternal />);
